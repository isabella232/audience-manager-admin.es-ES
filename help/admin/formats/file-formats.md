---
description: Enumera las macros que puede utilizar para crear archivos de datos basados en FTP. Algunas macros se pueden utilizar para todos los campos y filas de archivos de datos. Otras macros son específicas de las filas de datos y encabezados.
seo-description: Enumera las macros que puede utilizar para crear archivos de datos basados en FTP. Algunas macros se pueden utilizar para todos los campos y filas de archivos de datos. Otras macros son específicas de las filas de datos y encabezados.
...
Enumera las macros que puede utilizar para crear archivos [!DNL FTP]de datos basados en. Algunas macros se pueden utilizar para todos los campos y filas de archivos de datos. Otras macros son específicas de las filas de datos y encabezados.
...
<table id="table_A3309E175ABF4651BD11CE3632B3C553"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Indica el tipo de sincronización. Acepta las siguientes variables opcionales: </p> 
    <ul id="ul_87E8E3CE6565447A9810B5119298CC7B"> 
     <li id="li_66F4889FB84E40AC92F69F3FF6B0042C"> <code>completo</code>: Sincronización completa. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Marca de tiempo UTC, Unix de 10 dígitos. </p> <p>También se puede formatear como <code>AAAAMMDDhhmmss</code> siguiendo las reglas de formato de fecha/marca de hora de Java. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E378F94A3907407AA8110C8EE6C10909"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Inserta un carácter } con corchetes cerrados. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="term"> Identificador de usuario único de socio de datos </span>. Devuelve el ID asignado a un visitante de usuario o sitio si dicho ID ya se ha sincronizado con un ID de dispositivo de <span class="keyword"> Audience Manager </span> . </p> <p>Si el DPID es 0, esta macro devolverá el ID de <span class="keyword"> Audience Manager </span> en lugar del ID del usuario. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Necesario cuando se utilizan las macros condicional <code>if</code> y <code>SEGMENT_LIST</code> y <code>REMOVED_SEGMENT_LIST</code> . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>if(SEGMENT_LIST &amp;&amp; REMOVED_SEGMENT_LIST)endif</code> </p> </td> 
   <td colname="col2"> <p>Esta combinación de macros crea una afirmación condicional que enumera los segmentos a los que pertenecen los usuarios <i>y de los</i> que se han eliminado. Devuelve una cadena vacía si no se cumplen ambas condiciones o no hay datos. </p> </td> 
  </tr> 
  <tr> 
    ...
    <ul id="ul_757DEB56E4F849768468F3C166B0D171"> 
     <li id="li_859E1F4F21D645519F150DC512B3EB1A"> <code>type</code>: Tipos de características identificados por un ID numérico. Esta variable devuelve: 
      <ul id="ul_C9839266783D42CCADAAC3FEA33BE4D7"> 
       ...
       <li id="li_831FF929BF50434C8804C13E5786DF79"> <code>3</code> que identifica una característica basada en reglas (tiempo real, incorporado a través del <span class="wintitle"> DCS </span>). </li> 
      </ul> </li> 
