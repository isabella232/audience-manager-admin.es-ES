...
El presente Código de conducta es una adaptación de la [Pacto del colaborador][homepage], versión 1.4, disponible en [https://contributor-covenant.org/version/1/4][version]
